...
bool runtest(string oldName, string newName, string diffName, string newName2)
{
    ...
    if (!equal(istreambuf_iterator<char>(newFile), istreambuf_iterator<char>(),
        ...
        int main()
        {
            assert(runtest("/Users/gurbirarora/Desktop/warandpeace1.txt", "/Users/gurbirarora/Desktop/warandpeace2.txt", "/Users/gurbirarora/Desktop/empty.txt", "/Users/gurbirarora/Desktop/test2.txt"));
